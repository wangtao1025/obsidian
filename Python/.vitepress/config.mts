...
export default defineConfig({
  ...
  head: [
    [
      ...
      {
        rel: "stylesheet",
        href: "https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.css",
      },
    ],
  ],
    ...
    config: (md) => {
      ...
      md.renderer.rules.fence = (tokens, idx, options, env, self) => {
        ...
        if (lang === "mermaid") {
          ...
          return (
            '<div class="mermaid-zoom-wrapper"><pre class="mermaid">' +
            code +
            "</pre></div>\n"
          );
        }
        ...
        const content = token.content ? md.utils.escapeHtml(token.content) : "";
        const infoStr = (token.info || "").trim();
        return `<pre><code${infoStr ? ` class="language-${infoStr.split(/\s/)[0]}"` : ""}>${content}</code></pre>\n`;
      };
    },
  },
        ...
        },
        {
          ...
          items: [
            ...
            { text: "text_splitter", link: "/python/AI课程-text_splitter" },
            {
              ...
              link: "/python/AI课程-sentence_transformers",
            },
      ...
      "/ai/": [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "Milvus 与 PyMilvus",
              link: "/ai/AI课程-Milvus向量数据库与PyMilvus",
            },
        ...
        },
        {
          ...
          items: [
            ...
            { text: "BPETokenizer", link: "/ai/AI课程-BPETokenizer" },
            {
              ...
              link: "/ai/AI课程-PromptEngineering",
            },
      ...
      "/frontend/": [
        {
          ...
          items: [
            ...
            {
              text: "占位目录（JS / TS / Vue / React / Next / Vite）",
              link: "/frontend/#占位目录",
            },
          ],
        },
      ...
      "/linux/": [
        {
          ...
          items: [
            { text: "首页", link: "/linux/" },
            {
              text: "Linux 入门与常用命令手册",
              link: "/linux/Linux入门与常用命令手册",
            },
          ],
        },
      ],
      "/docker/": [
        {
          ...
          items: [
            { text: "首页", link: "/docker/" },
            {
              text: "Docker 入门与常用命令手册",
              link: "/docker/Docker入门与常用命令手册",
            },
