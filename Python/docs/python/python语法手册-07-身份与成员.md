# 身份判断( == 与 is) 与 成员运算符号 (in 与 not in)

← [语法手册总览](/python/python语法手册) | [上一章 逻辑与真值](/python/python语法手册-06-逻辑与真值) | [下一章 数据处理](/python/python语法手册-08-数据处理)

---

**本章对应自测卷**：[八、身份判断与成员运算符（共 8 题）](/python/Python核心语法自测试卷#八身份判断与成员运算符-共-8-题)  
...
## 一、身份判断( == 与 is) 与 成员运算符号 (in 与 not in)
